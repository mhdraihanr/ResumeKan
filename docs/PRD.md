...
| F2  | Form CV           | Data pribadi (termasuk foto profil opsional via upload Cloudinary), ringkasan, pengalaman kerja (employment type Full-time/Part-time/Internship, bullet per baris), pendidikan (IPK opsional, angka bold), organisasi (max 5), keahlian sebagai grup berlabel — 2 grup bawaan (hard/soft) + grup kustom s.d. 5 grup total (mis. "Library & Frameworks", "Tools"), bahasa, sertifikat terstruktur (max 5: nama/penerbit/tahun/credential ID opsional, section sendiri), proyek terstruktur (max 8: title/role/objective/techStack/link opsional) |
| F3  | Preview real-time | Render CV saat form diisi, 3 template (modern, classic, neon), kustomisasi 5 jenis font ATS-friendly dan 3 preset ukuran font (kompak/standar/lega)                                                                                                                                                                                                                                                                                                                                                                                             |
