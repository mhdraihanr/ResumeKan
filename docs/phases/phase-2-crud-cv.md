...
| `web/src/components/cv/CvForm.vue` | Shell form: stepper nav 9 langkah + step navigation + state (refactor 2026-08-31: 928→~150 baris, isi per langkah pindah ke `steps/*.vue`, field ke `form/FormInput | Textarea | Select | Label.vue`) |
