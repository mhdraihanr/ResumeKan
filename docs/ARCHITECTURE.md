...
1. **PDF berbasis teks:** `PdfService` memakai Chromium `Page.printToPDF` → vektor font + text operators asli, 100% selectable/copy-pasteable. Tidak ada rasterisasi teks.
